// Tuan 3 - Bai 2: Lop phan so (tu so, mau so)
...
int main() {
  ...
  cout << "\nTong   = ";
  kq = a.cong(b); kq.xuat(); cout << endl;
  cout << "Hieu   = ";
  kq = a.tru(b); kq.xuat(); cout << endl;
  cout << "Tich   = ";
  kq = a.nhan(b); kq.xuat(); cout << endl;
  cout << "Thuong = ";
  kq = a.chia(b); kq.xuat(); cout << endl;
